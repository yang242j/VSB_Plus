...
<body>
    ...
    <div class="container">
		<div class="welcome_tag" id = "welcome">
			...
			<p style='font-size:18px'>Tips: </p>
			<p style='font-size:18px'>1.drag the course form course to take box and drop it on Customize Schedule Builder box.</p>
			<p style='font-size:18px'>The system will match the prerequiste and term for user, if confict happens some tips will show up. </p>
