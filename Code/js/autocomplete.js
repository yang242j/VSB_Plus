...
function autocomplete(inputText, array2Check) {
    ...
    inputText.addEventListener("input", function(e) {
        ...
        for (i = 0; i < array2Check.length; i++) {
            ...
            /*check if the shortName of the course object starts with the same letters as the text field value:*/
            if (array2Check[i].faculty.substr(0, val.length).toUpperCase() == val.toUpperCase()) {
                
                /*create a DIV element for each matching element:*/
                b = document.createElement("DIV");
                
                /*make the matching letters bold:*/
                b.innerHTML = "<strong>" + array2Check[i].faculty.substr(0, val.length) + "</strong>";
                b.innerHTML += array2Check[i].faculty.substr(val.length);
