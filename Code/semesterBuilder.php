...
<body>
    ...
    <nav>
        <div class="nav-right">
            <a class="nav-active" id="usertext" onclick="toogleDisplay('addon-menu')">
            ...
            <div class="bottom_right" id="course_recommended">
                ...
                <script>
                    ...
                    function loadRecCourseTags() {
                        ...
                        fetchRecJSON(courseCompletedList, major="<?php echo htmlspecialchars(
                            $_SESSION['major']
                        ); ?>", term, maxNum=10).done(function (result) {
